...
import static com.cash.pay.helper.Helper.FRAGMENT_CHANGE_PASSWORD;
...
public class FragmentProfile extends Fragment {
    ...
    LinearLayout p_logout,history,rate,t_of_s,p_policy,cont,change_password_btn, deleteAccount;
    CardView fb,tg;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        deleteAccount = root_view.findViewById(R.id.delete_account);
        ...
        deleteAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setMessage("Deleting this Account will result completely removing your" +
                        "Account from the system and won't be able to access the app.");
                      ...
                      firebaseUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                          ...
                          public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()) {
                              Toast.makeText(requireContext(), "Account Deleted",
