package com.cash.pay.csm.adapter;

import static com.cash.pay.Just_base.addPoint;
...
import static com.cash.pay.helper.PrefManager.ADMOB_REWARDED_ID;
import static com.cash.pay.helper.PrefManager.VUNGLE_REWARDED_ID;
...
import com.cash.pay.csm.IsVideoLimitReach;
import com.cash.pay.csm.model.OfferWall_Model;
...
public class OfferWall_Adapter extends RecyclerView.Adapter<OfferWall_Adapter.ViewHolder> {
    ...
    public OfferWall_Adapter(List<OfferWall_Model> offer_data, Activity context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (offer.getType().equals("colony")) {
            holder.k.setText(offer.getPoints() + "+");
        ...
        if (offer.getType().equals("iron_offer")) {
            IronSource.setOfferwallListener(new OfferwallListener() {
                ...
                public boolean onOfferwallAdCredited(int credits, int totalCredits, boolean totalCreditsFlag) {
                    addPoint(context, String.valueOf(credits), "Iron Source offerwall points credited");
                    return true;
                }
                ...
                if (offer.getType().equals("adget")) {
                        ...
                        public void onOfferWallLoadSuccess() {
                            ...
                            AdGateMedia.getInstance().showOfferWall(context, new AdGateMedia.OnOfferWallClosed() {
                                ...
                                public void onOfferWallClosed() {
                                    ...
                                    AdGateMedia.getInstance().getConversions(context, ADGET_WALL_id, AppController.getInstance().getId(), subids, new OnConversionsReceived() {
                                        @Override
                                        public void onSuccess(List<Conversion> conversions) {
                                            ...
                                            for (Conversion conversion : conversions)  {
                                                if (context != null) {
                                                    addPoint(context, String.valueOf((int) conversion.points), "AdGate offerwall points");
                                                }
                                            }
                                        }
                    ...
                    OffersInit.getInstance().setOfferWallListener(new OfferWallListener() {
                        ...
                        public void onOTOfferWallCredited(double credits, double totalCredits) {
                            addPoint(context, String.valueOf((int) credits), "Offer toro offerwall points credited");
                        }
